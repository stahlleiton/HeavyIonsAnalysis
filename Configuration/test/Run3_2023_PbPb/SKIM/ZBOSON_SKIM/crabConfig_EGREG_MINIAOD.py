...
config.General.requestName = 'HIPhysicsRawPrime_EGREG_HIRun2023_PromptReco_MINIAOD_'+date
...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/anstahll/hintt/Run3_2023_PbPb/MINIAOD/EGREG/'+date
