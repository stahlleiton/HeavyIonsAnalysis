...
date = '2025_2_10'
config.General.workArea = 'crab_projects/'+date+'/DATA_RECOVERY'
...
## Submit the PDs
for i in [14, 15, 21]:
    config.General.requestName = f'HiForest_HIPhysicsRawPrime{i}_HIRun2023A_PromptReco_v2_SKIM_'+date+'_RECOVERY'
    config.Data.lumiMask = f'crab_projects/{date}/DATA/crab_HiForest_HIPhysicsRawPrime{i}_HIRun2023A_PromptReco_v2_SKIM_{date}/results/notFinishedLumis.json'
