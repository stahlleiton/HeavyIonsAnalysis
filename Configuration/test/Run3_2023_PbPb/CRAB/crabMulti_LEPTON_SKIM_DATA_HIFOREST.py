...
tryMulti = True
date = '2025_10_22'
config.General.workArea = 'crab_projects/'+date+'/DATA_LEPTON'
config.General.transferOutputs = True
config.General.transferLogs = False
config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../forest_miniAOD_ParticleTransformer_run3_LEPTON_SKIM_DATA.py'
config.JobType.maxMemoryMB = 2999
config.JobType.maxJobRuntimeMin = 1749
config.section_('Data')
config.Data.outLFNDirBase = '/store/group/cmst3/group/hintt/Run3_2023_PbPb/HiForest/'+date+'/DATA_LEPT'
config.Data.publication = False
config.section_('Site')
config.Site.storageSite = 'T2_CH_CERN'
#config.Site.ignoreGlobalBlacklist = True # to fix issue of missing blocks
config.Site.blacklist = ['T2_TR_METU']
