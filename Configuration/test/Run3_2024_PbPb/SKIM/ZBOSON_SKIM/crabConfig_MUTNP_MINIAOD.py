...
config.General.requestName = 'HIPhysicsRawPrime_MUTNP_HIRun2024_PromptReco_MINIAOD_'+date
...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/anstahll/hintt/Run3_2024_PbPb/MINIAOD/MUTNP/'+date
