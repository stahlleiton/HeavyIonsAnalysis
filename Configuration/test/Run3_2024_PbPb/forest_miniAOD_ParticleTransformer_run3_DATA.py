...
for jetR, doFlow in zip([0.3], [False]):
    ...
    candidateBtaggingMiniAOD(process, isMC = False, jetPtMin = jetPtMin, jetR = jetR, jetCorrLevels = ['L2Relative', 'L2L3Residual'], doFlow = doFlow, addNegTag = True, isSkim = True, era = "Run3_2024_PbPb")
