...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/data/Run2024J/PPRefSingleMuon2/MINIAOD/PromptReco-v1/000/387/606/00000/cc433506-1095-4592-804e-e7e0a4d5bd69.root'),
)
...
process.leptonSelection = cms.Sequence(process.goodMuons * process.oneMuon)
