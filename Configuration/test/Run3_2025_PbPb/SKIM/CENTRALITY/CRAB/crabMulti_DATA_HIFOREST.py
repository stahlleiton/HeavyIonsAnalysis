...
config.Data.outLFNDirBase = '/store/group/cmst3/group/hintt/Run3_2025_PbPb/HiForest/'+date+'/DATA/MINBIAS'
config.Data.publication = False
config.section_('Site')
config.Site.storageSite = 'T2_CH_CERN'
config.Site.ignoreGlobalBlacklist = True # to fix issue of missing blocks
config.Data.ignoreLocality = True
config.Site.whitelist = ['T1_US_*', 'T1_FR_*', 'T2_FR_*', 'T2_ES_*', 'T2_UK_*', 'T2_US_*', 'T2_CH_*']
...
for i in range(0, 1, 1):
    config.General.requestName = f'HiForest_HIPhysicsRawPrime{i}_HIRun2025A_PromptReco_v1_'+date
