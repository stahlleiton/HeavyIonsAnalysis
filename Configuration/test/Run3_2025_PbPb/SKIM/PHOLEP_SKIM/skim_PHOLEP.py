...
# with command line options: skim --conditions 151X_dataRun3_Prompt_v1 -s NONE --datatier MINIAOD --eventcontent MINIAOD --data --process SKIM --scenario pp --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3_pp_on_PbPb_2025 --filein /store/hidata/HIRun2025A/HIPhysicsRawPrime0/MINIAOD/PbPbEW-PromptReco-v1/000/399/485/00000/6a31df14-1615-43e8-8f3a-351327a47980.root --fileout miniaod.root --era Run3_pp_on_PbPb_2025 --nThreads 8 -n -1
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_pp_on_PbPb_2025_cff import Run3_pp_on_PbPb_2025

process = cms.Process('SKIM',Run3_pp_on_PbPb_2025)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/hidata/HIRun2025A/HIPhysicsRawPrime9/MINIAOD/PromptReco-v1/000/400/414/00000/b3b6f3c8-ff1d-4015-89ae-52d9db706239.root'),
