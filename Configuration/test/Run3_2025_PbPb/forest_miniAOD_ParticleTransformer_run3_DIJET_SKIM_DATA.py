...
process.hltanalysis.l1dummybranches = dummy_branches_for_PbPb_2025_L1
...
process.leptonJetSelection = cms.Sequence(process.goodElectrons * process.goodMuons * process.PackedPFTowers * process.hiPuRho * process.          oneLeptonOrTwoJets1 * process.oneLeptonOrTwoJets2)
