...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/user/anstahll/hintt/Run3_2026_PbPb/MINIAOD/PHOLEP/2026_08_07/HIPhysicsRawPrime/HIPhysicsRawPrime_PHOLEP_HIRun2026_PromptReco_MINIAOD_2026_08_07/260807_172251/0000/miniaod_103.root'),
)
...
for jetR, doFlow in zip([0.3], [False]):
    ...
    candidateBtaggingMiniAOD(process, isMC = False, jetPtMin = jetPtMin, jetR = jetR, jetCorrLevels = ['L2Relative', 'L2L3Residual'], doFlow = doFlow, addNegTag = True, isSkim = True, era = "Run3_2026_PbPb")
