...
config.Data.outLFNDirBase = '/store/group/cmst3/group/hintt/Run3_2026_PbPb/HiForest/'+date+'/DATA/MINBIAS'
...
for i in range(0, 1, 1):
    config.General.requestName = f'HiForest_HIPhysicsRawPrime{i}_HIRun2026A_PromptReco_v1_'+date
