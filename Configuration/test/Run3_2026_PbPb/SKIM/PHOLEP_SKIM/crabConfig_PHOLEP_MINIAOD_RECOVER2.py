...
date = '2026_08_07'
config.General.workArea = 'crab_projects/RECOVER2_'+date
config.General.requestName = 'HIPhysicsRawPrime_PHOLEP_HIRun2026_PromptReco_MINIAOD_RECOVER2_'+date
config.General.transferOutputs = True
config.General.transferLogs = False
config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'skim_PHOLEP_RECOVER.py'
...
infile = 'zboson_promptskim_RECOVER2.txt'
