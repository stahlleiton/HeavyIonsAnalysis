...
config.General.requestName = 'HIPhysicsRawPrime_MUTNP_HIRun2026_PromptReco_MINIAOD_v4_'+date
...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/anstahll/hintt/Run3_2026_PbPb/MINIAOD/MUTNP/'+date
