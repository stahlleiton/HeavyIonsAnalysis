...
bool pat::HIMuonMVAProducer::passMVAIso(const double& mva, const double& cent, const WP& wp) const {
  ...
  if (era_ == "Run3_2023_PbPb") {
    ...
    //Working point: WP95
    if (wp == WP95)
      cut = 1.2499957800987562e-06 * cen3 + -0.00012170801189668024 * cen2 + 0.0009646003880893901 * cent +
            0.42182802645206190;
    //Working point: WP90
    else if (wp == WP90)
      cut = 6.8120884256689200e-07 * cen3 + -5.506334371017415e-05 * cen2 + -0.0009935529044038545 * cent +
            0.25104723318639510;
    //Working point: WP85
    else if (wp == WP85)
      cut = 4.4843266795507336e-07 * cen3 + -3.163070883128350e-05 * cen2 + -0.0011605388501508378 * cent +
            0.16379223117933261;
    //Working point: WP80
    else if (wp == WP80)
      cut = 3.2227736813983527e-07 * cen3 + -2.157298771356158e-05 * cen2 + -0.0009560693877558988 * cent +
            0.11370835071080256;
  } else
